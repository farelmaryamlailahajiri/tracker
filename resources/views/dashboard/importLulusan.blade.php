                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered w-100" id="dataTable" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach ($alumni as $index)
                                            <tr>
                                                <td>{{ $loop->iteration + ($alumni->currentPage() - 1) * $alumni->perPage() }}
                                                </td>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div>
                                        Showing {{ $alumni->firstItem() }} to {{ $alumni->lastItem() }} of
                                        {{ $alumni->total() }} entries
                                    </div>
                                    <div>
                                        <nav>
                                            <ul class="pagination mb-0">
                                                ...
                                                @else
                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ $alumni->previousPageUrl() }}"
                                                            rel="prev">Previous</a>
                                                    </li>
                                                @endif
                                                ...
                                                @if ($alumni->hasMorePages())
                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ $alumni->nextPageUrl() }}"
                                                            rel="next">Next</a>
                                                    </li>
                                                @else
                    ...
                    <div class="modal-body">
                        <form id="import-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ asset('Template_Lulusan.xlsx') }}" class="btn btn-sm btn-success mb-3"
                                    download>
